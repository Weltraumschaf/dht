...
public final class Messaging {
     ...
     * @return never {@code null}, always new instance
     */
    public static Message newProtocollMessage(final MessageType type, final NetworkAddress from, final NetworkAddress to, final Void body) {
        switch (type) {
            case PING:
    ...
    private static final class ProcollMessages {
         ...
         * @return never {@code null}, always new instance
         */
        public ProtocollMessage newPingMessage(final NetworkAddress from, final NetworkAddress to, final Void body) {
            return new ProtocollMessage.PingMessage(nextId(), from, to, body);
        }
         ...
         * @return never {@code null}, always new instance
         */
        public ProtocollMessage newStoreMessage(final NetworkAddress from, final NetworkAddress to, final Void body) {
            return new ProtocollMessage.StoreMessage(nextId(), from, to, body);
        }
         ...
         * @return never {@code null}, always new instance
         */
        public ProtocollMessage newFindNodeMessage(final NetworkAddress from, final NetworkAddress to, final Void body) {
            return new ProtocollMessage.FindNodeMessage(nextId(), from, to, body);
        }
         ...
         * @return never {@code null}, always new instance
         */
        public ProtocollMessage newFindValueMessage(final NetworkAddress from, final NetworkAddress to, final Void body) {
            return new ProtocollMessage.FindValueMessage(nextId(), from, to, body);
        }
    }
}
